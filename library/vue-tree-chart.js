  ...
  return (function (t) {
    ...
    function (t, n, e) {
      ...
      function T(t, n, e) {
        ...
        ;(n.convertToAbsoluteUrls || o) && (r = h(r)),
          i &&
            (r +=
    ...
    function (t, n, e) {
      ...
      var i = function () {
        var t = this,
          n = t.$createElement,
          e = t._self._c || n
        return e('div', { ref: 'container', staticClass: 'tree-container' }, [
          e('svg', {
            ref: 'svg',
          ...
          e(
            ...
            [
              e(
                'transition-group',
                { attrs: { name: 'tree-node-item', tag: 'div' } },
                t._l(t.nodeDataList, function (n, r) {
                  return e(
                    'div',
                    {
                      ...
                      style: {
                        left: t.formatDimension(
                          t.direction === t.DIRECTION.VERTICAL ? n.x : n.y
                        ),
                        top: t.formatDimension(
                          t.direction === t.DIRECTION.VERTICAL ? n.y : n.x
                        ),
      ...
      function A(t, n, e) {
        var r = (n - t) / Math.max(0, e),
          ...
          o = r / Math.pow(10, i)
        return i >= 0
          ? (o >= k ? 10 : o >= N ? 5 : o >= E ? 2 : 1) * Math.pow(10, i)
          : -Math.pow(10, -i) / (o >= k ? 10 : o >= N ? 5 : o >= E ? 2 : 1)
      }
      function R(t, n, e) {
      ...
      var z = function (t) {
        ...
        L = function () {
          ...
          function r(r) {
            ...
            Array.isArray(h) ||
              ((h = R(f, s, h)),
              (h = S(Math.ceil(f / h) * h, Math.floor(s / h) * h, h)))
            for (var d = h.length; h[0] <= f; ) h.shift(), --d
            for (; h[d - 1] > s; ) h.pop(), --d
            var p,
              v = new Array(d + 1)
            for (i = 0; i <= d; ++i)
              ((p = v[i] = []).x0 = i > 0 ? h[i - 1] : f),
                (p.x1 = i < d ? h[i] : s)
            for (i = 0; i < u; ++i)
              f <= (o = a[i]) && o <= s && v[l(h, o, 0, d)].push(r[i])
            return v
          }
          return (
            (r.value = function (n) {
        ...
        U = function (t, n, e) {
          return (
            ...
            Math.ceil(
              (e - n) /
                (2 * (P(t, 0.75) - P(t, 0.25)) * Math.pow(t.length, -1 / 3))
            )
          )
        },
        D = function (t, n, e) {
        ...
        q = function (t, n) {
          var e,
            ...
            o = -1,
            u = 0
          if (null == n) for (; ++o < r; ) isNaN((e = y(t[o]))) ? --i : (u += e)
          else for (; ++o < r; ) isNaN((e = y(n(t[o], o, t)))) ? --i : (u += e)
          if (i) return u / i
        },
        I = function (t, n) {
          var e,
            ...
            i = -1,
            o = []
          if (null == n) for (; ++i < r; ) isNaN((e = y(t[i]))) || o.push(e)
          else for (; ++i < r; ) isNaN((e = y(n(t[i], i, t)))) || o.push(e)
          return P(o.sort(u), 0.5)
        },
        j = function (t) {
        ...
        on: function (t, n) {
          ...
          if (!(arguments.length < 2)) {
            ...
            for (; ++o < u; )
              ...
              else if (null == n) for (e in r) r[e] = ht(r[e], t.name, null)
            return this
          }
          for (; ++o < u; )
      ...
      var dt = ct,
        ...
        yt = function (t) {
          ...
          return (
            ...
            vt.hasOwnProperty(n) ? { space: vt[n], local: t } : t
          )
        }
      function gt(t) {
        return function () {
      ...
      'undefined' != typeof document &&
        ('onmouseenter' in document.documentElement ||
          (pn = { mouseenter: 'mouseover', mouseleave: 'mouseout' }))
      function yn(t, n, e) {
        return (
          (t = gn(t, n, e)),
          function (n) {
      ...
      function Nn() {
        return new kn([[document.documentElement]], Sn)
      }
      kn.prototype = Nn.prototype = {
        ...
        style: function (t, n, e) {
          return arguments.length > 1
            ? this.each(
                (null == n ? jt : 'function' == typeof n ? Yt : Ft)(
                  t,
                  n,
                  null == e ? '' : e
                )
        ...
        property: function (t, n) {
          return arguments.length > 1
            ? this.each(
                (null == n ? Ht : 'function' == typeof n ? Xt : $t)(t, n)
              )
            : this.node()[t]
        },
        ...
        html: function (t) {
          return arguments.length
            ? this.each(null == t ? on : ('function' == typeof t ? an : un)(t))
            : this.node().innerHTML
        },
        raise: function () {
          return this.each(cn)
        ...
        on: function (t, n, e) {
          var r,
            ...
            u = o.length
          if (!(arguments.length < 2)) {
            for (a = n ? xn : mn, null == e && (e = !1), r = 0; r < u; ++r)
              this.each(a(o[r], n, e))
            return this
          }
      ...
      var En = Nn,
        Cn = function (t) {
          return 'string' == typeof t
            ? new kn([[document.querySelector(t)]], [document.documentElement])
            : new kn([[t]], Sn)
        },
        An = function (t) {
      ...
      var Pn = function () {
        ...
        On = function (t) {
          return 'string' == typeof t
            ? new kn([document.querySelectorAll(t)], [document.documentElement])
            : new kn([null == t ? [] : t], Sn)
        },
        qn = function (t, n, e) {
      ...
      var Gn = function () {
          ...
          function v() {
            Cn(vn.view).on('mousemove.drag mouseup.drag', null),
              Bn(vn.view, e),
              Fn(),
              c.mouse('end')
          }
          function y() {
            if (i.apply(this, arguments)) {
              var t,
                ...
                u = e.length
              for (t = 0; t < u; ++t)
                (n = m(e[t].identifier, r, qn, this, arguments)) &&
                  (jn(), n('start'))
            }
          }
          function g() {
          ...
          function m(t, n, e, r, i) {
            ...
            if (
              bn(
                new $n(h, 'beforestart', o, t, s, d[0], d[1], 0, 0, p),
                function () {
                  return (
                    null != (vn.subject = o = u.apply(r, i)) &&
          ...
          return (
            (h.filter = function (t) {
              return arguments.length
                ? ((i = 'function' == typeof t ? t : Hn(!!t)), h)
                : i
            }),
            (h.container = function (t) {
              return arguments.length
                ? ((o = 'function' == typeof t ? t : Hn(t)), h)
                : o
            }),
            (h.subject = function (t) {
              return arguments.length
                ? ((u = 'function' == typeof t ? t : Hn(t)), h)
                : u
            }),
            (h.touchable = function (t) {
              return arguments.length
                ? ((a = 'function' == typeof t ? t : Hn(!!t)), h)
                : a
            }),
            (h.on = function () {
      ...
      function he(t) {
        ...
        return (
          ...
          (n = re.exec(t))
            ...
            : (n = fe.exec(t))
            ? _e(n[1], n[2] / 100, n[3] / 100, 1)
            : (n = se.exec(t))
            ? _e(n[1], n[2] / 100, n[3] / 100, n[4])
            : le.hasOwnProperty(t)
            ? de(le[t])
            : 'transparent' === t
        ...
        return (
          a
            ? ((u =
              ...
              (u *= 60))
            : (a = c > 0 && c < 1 ? 0 : u),
          new be(u, a, c, t.opacity)
        )
      }
      function xe(t, n, e, r) {
        return 1 === arguments.length
          ? me(t)
          : new be(t, n, e, null == r ? 1 : r)
      }
      function be(t, n, e, r) {
      ...
      function Se(t) {
        ...
        var e = Re(t.r),
          r = Re(t.g),
          i = Re(t.b),
          o = Ee((0.4124564 * e + 0.3575761 * r + 0.1804375 * i) / 0.95047),
          u = Ee((0.2126729 * e + 0.7151522 * r + 0.072175 * i) / 1)
        return new Ne(
          116 * u - 16,
          500 * (o - u),
          200 *
            (u - Ee((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / 1.08883)),
          t.opacity
        )
      }
      function ke(t, n, e, r) {
        ...
        Jn(Kn, {
          ...
          rgb: function () {
            ...
            return (
              ...
              new ge(
                Ae(
                  3.2404542 * (n = 0.95047 * Ce(n)) -
                    1.5371385 * t -
                    0.4985314 * (e = 1.08883 * Ce(e))
                ),
                Ae(-0.969266 * n + 1.8760108 * t + 0.041556 * e),
                Ae(0.0556434 * n - 0.2040259 * t + 1.0572252 * e),
                this.opacity
              )
            )
          }
      ...
      Qn(
        ...
        Jn(Kn, {
          brighter: function (t) {
            return (
              (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)),
              new Fe(this.h, this.s, this.l * t, this.opacity)
            )
          },
          darker: function (t) {
            return (
      ...
      function Ve(t, n) {
        var e = n - t
        return e
          ? Xe(t, e > 180 || e < -180 ? e - 360 * Math.round(e / 360) : e)
          : $e(isNaN(t) ? n : t)
      }
      function We(t) {
        return 1 == (t = +t)
      ...
      var ur,
        ...
        sr = function (t, n) {
          var e,
            r,
            i,
            o = (ir.lastIndex = or.lastIndex = 0),
            u = -1,
            a = [],
            c = []
          for (t += '', n += ''; (e = ir.exec(t)) && (r = or.exec(n)); )
            (i = r.index) > o &&
          ...
          function (t) {
            return 'none' === t
              ...
              : (ur ||
                  ...
                  (cr = document.defaultView)),
                (ur.style.transform = t),
                (t = cr
                  .getComputedStyle(ar.appendChild(ur), null)
                  .getPropertyValue('transform')),
                ar.removeChild(ur),
                (t = t.slice(7, -1).split(',')),
                vr(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]))
          },
          'px, ',
          'px)',
          'deg)'
            ...
            return null == t
              ...
              : (fr ||
                ...
                (t = fr.transform.baseVal.consolidate())
                  ? ((t = t.matrix), vr(t.a, t.b, t.c, t.d, t.e, t.f))
                  : pr)
          },
          ', ',
          ')',
      ...
      function Gr(t) {
        Ur ||
          ...
          t - Ir > 24
            ? (t < 1 / 0 && (Dr = setTimeout(Wr, t - Fr.now() - jr)),
              Or && (Or = clearInterval(Or)))
            : (Or || ((qr = Fr.now()), (Or = setInterval(Zr, 1e3))),
              (Ur = 1),
              Yr(Wr)))
      }
      $r.prototype = Xr.prototype = {
        ...
        restart: function (t, n, e) {
          ...
          ;(e = (null == e ? Br() : +e) + (null == n ? 0 : +n)),
            this._next ||
              Rr === this ||
              (Rr ? (Rr._next = this) : (Ar = this), (Rr = this)),
            (this._call = t),
            (this._time = e),
            Gr()
        },
                ...
                if ((h = i[f]).name === e.name) {
                  ...
                  4 === h.state
                    ? ((h.state = 6),
                      ...
                      delete i[f])
                    : +f < n && ((h.state = 6), h.timer.stop(), delete i[f])
                }
              if (
                (Qr(function () {
                  3 === e.state &&
      ...
      Ni.prototype = Ei.prototype = {
        ...
        attr: function (t, n) {
          ...
          return this.attrTween(
            t,
            'function' == typeof n
              ? (e.local ? vi : pi)(e, r, ci(this, 'attr.' + t, n))
              : null == n
              ? (e.local ? li : si)(e)
              : (e.local ? di : hi)(e, r, n + '')
          )
                ...
                'function' == typeof n
                  ? (function (t, n, e) {
                      ...
                      return function () {
                        ...
                        return (
                          null == a &&
                            (this.style.removeProperty(t), (a = Bt(this, t))),
                          u === a
                            ? null
                            : u === r && a === i
                            ? o
        ...
        tween: function (t, n) {
          ...
          if (((t += ''), arguments.length < 2)) {
            for (
              var r, i = ii(this.node(), e).tween, o = 0, u = i.length;
              o < u;
              ++o
            )
        ...
        delay: function (t) {
          var n = this._id
          return arguments.length
            ? this.each(('function' == typeof t ? _i : mi)(n, t))
            : ii(this.node(), n).delay
        },
        duration: function (t) {
          var n = this._id
          return arguments.length
            ? this.each(('function' == typeof t ? xi : bi)(n, t))
      ...
      var no = (function t(n) {
        ...
        co = { time: null, delay: 0, duration: 250, ease: Oi }
      function fo(t, n) {
      ...
      var yo = function () {
        ...
        ko = { n: 's', s: 'n', nw: 'sw', ne: 'se', se: 'ne', sw: 'nw' },
        No = {
          overlay: 1,
          selection: 1,
          n: null,
      ...
      function qo(t) {
        ...
        function s() {
          ...
          if (r.apply(this, arguments)) {
            var e,
              ...
              x =
                'selection' === (vn.metaKey ? (m = 'overlay') : m)
                  ? go
                  : vn.altKey
                  ? xo
                  : mo,
            ...
            'overlay' === m
              ...
              : ((e = S[0][0]), (o = S[0][1]), (f = S[1][0]), (l = S[1][1])),
              (i = e),
              (u = o),
              (s = f),
              (h = l)
          ...
          function q() {
            ...
            switch (((d = z[0] - R[0]), (p = z[1] - R[1]), x)) {
              ...
              case go:
                b &&
                  ((d = Math.max(k - e, Math.min(E - f, d))),
                  (i = e + d),
                  (s = f + d)),
                  w &&
                    ((p = Math.max(N - o, Math.min(C - l, p))),
                    (u = o + p),
                    (h = l + p))
                break
              case mo:
                b < 0
                  ? ((d = Math.max(k - e, Math.min(E - e, d))),
                    (i = e + d),
                    (s = f))
                  : b > 0 &&
                    ((d = Math.max(k - f, Math.min(E - f, d))),
                    (i = e),
                    (s = f + d)),
                  w < 0
                    ? ((p = Math.max(N - o, Math.min(C - o, p))),
                      (u = o + p),
                      (h = l))
                    : w > 0 &&
                      ((p = Math.max(N - l, Math.min(C - l, p))),
                      (u = o),
                      (h = l + p))
                break
              case xo:
                b &&
                  ((i = Math.max(k, Math.min(E, e - d * b))),
                  (s = Math.max(k, Math.min(E, f + d * b)))),
                  w &&
                    ((u = Math.max(N, Math.min(C, o - p * w))),
                    (h = Math.max(N, Math.min(C, l + p * w))))
            }
            s < i &&
              ((b *= -1),
              (t = e),
              ...
              (i = s),
              (s = t),
              m in So && U.attr('cursor', To[(m = So[m])])),
              h < u &&
                ((w *= -1),
                (t = o),
                (o = l),
                ...
                (u = h),
                (h = t),
                m in ko && U.attr('cursor', To[(m = ko[m])])),
          ...
          function I() {
            if ((vo(), vn.touches)) {
              ...
              n && clearTimeout(n),
                ...
                P.on('touchmove.brush touchend.brush touchcancel.brush', null)
            } else
              Bn(vn.view, v),
                D.on(
            ...
            P.attr('pointer-events', 'all'),
              U.attr('cursor', To.overlay),
              M.selection && (S = M.selection),
              Lo(S) && ((M.selection = null), a.call(_)),
              L.end()
          }
          function j() {
            switch (vn.keyCode) {
        ...
        return (
            ...
            n.selection
              ...
              : n.each(function () {
                  var n = this,
                    ...
                    u = c(n, r).beforestart()
                  oi(n),
                    (i.selection = null == o || Lo(o) ? null : o),
                    a.call(n),
                    u.start().brush().end()
                })
          }),
          (f.prototype = {
            ...
            emit: function (n) {
              bn(new po(u, n, t.output(this.state.selection)), i.apply, i, [
                n,
                this.that,
                this.args
              ])
          ...
          if (null === this._x1)
            ...
            if (Math.abs(s * a - c * f) > 1e-6 && i) {
              var h = e - o,
                ...
                g = Math.sqrt(l),
                _ =
                  i * Math.tan((Zo - Math.acos((p + l - v) / (2 * y * g))) / 2),
                m = _ / g,
                x = _ / y
              Math.abs(m - 1) > 1e-6 &&
                (this._ += 'L' + (t + m * f) + ',' + (n + m * s)),
                (this._ +=
                  'A' +
                  i +
                  ',' +
      ...
      var uu = function () {
        ...
        function u() {
          ...
          if (
            ...
            o.arc(0, 0, s, l, h),
            (l === y && h === g) ||
              (o.quadraticCurveTo(0, 0, v * Io(y), v * jo(y)),
              o.arc(0, 0, v, y, g)),
        ...
        return (
          (u.radius = function (t) {
            return arguments.length
              ? ((e = 'function' == typeof t ? t : Wo(+t)), u)
              : e
          }),
          (u.startAngle = function (t) {
            return arguments.length
              ? ((r = 'function' == typeof t ? t : Wo(+t)), u)
              : r
          }),
          (u.endAngle = function (t) {
            return arguments.length
              ? ((i = 'function' == typeof t ? t : Wo(+t)), u)
              : i
          }),
          (u.source = function (n) {
      ...
      var fu = cu,
        su = function () {
          ...
          function o(e, i, u, a) {
            ...
            for (
              var c, f, s, l = -1, h = e.length, d = r[i++], p = fu(), v = u();
              ++l < h;
      ...
      ;(Xu.copy = function () {
        var t,
          n,
          e = new Hu(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
          r = this._root
        if (!r) return e
        ...
        (Xu.visit = function (t) {
          var n,
            ...
            c = this._root
          for (
            c && a.push(new ju(c, this._x0, this._y0, this._x1, this._y1));
            (n = a.pop());
            ...
            if (
              ...
              var f = (r + o) / 2,
                s = (i + u) / 2
              ;(e = c[3]) && a.push(new ju(e, f, s, o, u)),
                (e = c[2]) && a.push(new ju(e, r, s, f, u)),
                (e = c[1]) && a.push(new ju(e, f, i, o, s)),
                (e = c[0]) && a.push(new ju(e, r, i, f, s))
            }
          return this
        }),
          ...
          for (
            ...
            if (i.length) {
              var o,
                ...
                s = (u + c) / 2,
                l = (a + f) / 2
              ;(o = i[0]) && e.push(new ju(o, u, a, s, l)),
                (o = i[1]) && e.push(new ju(o, s, a, c, l)),
                (o = i[2]) && e.push(new ju(o, u, l, s, f)),
      ...
      var Zu = function (t) {
        ...
        function o() {
          for (var t, o, a, c, f, s, l, h = n.length, d = 0; d < i; ++d)
            for (o = Bu(n, Vu, Wu).visitAfter(u), t = 0; t < h; ++t)
              (a = n[t]),
                (s = e[a.index]),
                (l = s * s),
                (c = a.x + a.vx),
        ...
        return (
          'function' != typeof t && (t = Ou(null == t ? 1 : +t)),
          ...
          (o.radius = function (n) {
            return arguments.length
              ? ((t = 'function' == typeof n ? n : Ou(+n)), a(), o)
              : t
          }),
          o
        )
      ...
      var Ju = function (t) {
        ...
        function s(r) {
          for (var i = 0, u = t.length; i < f; ++i)
            for (var a, c, s, l, h, d, p, v = 0; v < u; ++v)
              (c = (a = t[v]).source),
                (l = (s = a.target).x + s.vx - c.x - c.vx || qu()),
                (h = s.y + s.vy - c.y - c.vy || qu()),
                (l *= d =
        ...
        return (
          ...
          (s.strength = function (t) {
            return arguments.length
              ? ((a = 'function' == typeof t ? t : Ou(+t)), h(), s)
              : a
          }),
          (s.distance = function (t) {
            return arguments.length
              ? ((c = 'function' == typeof t ? t : Ou(+t)), d(), s)
              : c
          }),
          s
        )
      ...
      var na,
          ...
          function l() {
            ...
            for (
              ...
              null == (r = t[n]).fx
                ? (r.x += r.vx *= u)
                : ((r.x = r.fx), (r.vx = 0)),
                null == r.fy ? (r.y += r.vy *= u) : ((r.y = r.fy), (r.vy = 0))
          }
          function h() {
        ...
        ia = function () {
          ...
          return (
            ...
            (c.strength = function (t) {
              return arguments.length
                ? ((i = 'function' == typeof t ? t : Ou(+t)), f(), c)
                : i
            }),
        ...
        oa = function (t, n, e) {
          ...
          return (
            ...
            (a.strength = function (t) {
              return arguments.length
                ? ((u = 'function' == typeof t ? t : Ou(+t)), c(), a)
                : u
            }),
            (a.radius = function (n) {
              return arguments.length
                ? ((t = 'function' == typeof n ? n : Ou(+n)), c(), a)
                : t
            }),
            (a.x = function (t) {
        ...
        ua = function (t) {
          ...
          return (
            'function' != typeof t && (t = Ou(null == t ? 0 : +t)),
            (o.initialize = function (t) {
              ;(n = t), u()
            }),
            (o.strength = function (t) {
              return arguments.length
                ? ((i = 'function' == typeof t ? t : Ou(+t)), u(), o)
                : i
            }),
            (o.x = function (n) {
              return arguments.length
                ? ((t = 'function' == typeof n ? n : Ou(+n)), u(), o)
                : t
            }),
            o
          )
        ...
        la = {
          ...
          s: function (t, n) {
            ...
            var r = e[0],
              i = e[1],
              o =
                i - (na = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1,
              u = r.length
            return o === u
              ? r
              : o > u
          ...
          function c(t) {
            ...
            function m(t) {
              ...
              switch (
                (h &&
                  s &&
                  ((t = r(M + t, M.length ? l - x.length : 1 / 0)), (M = '')),
                e)
              ) {
                case '<':
                  t = m + t + x + M
      ...
      ba({ decimal: '.', thousands: ',', grouping: [3], currency: ['$', ''] })
      var wa = function (t) {
        ...
        Ma = function (t, n) {
          return Math.max(
            0,
            3 * Math.max(-8, Math.min(8, Math.floor(fa(n) / 3))) -
              fa(Math.abs(t))
          )
        },
        Ta = function (t, n) {
      ...
      var ec,
        ...
        sc = {
          ...
          polygonEnd: function () {
            var t = +cc
            fc.add(t < 0 ? za + t : t),
              (this.lineStart = this.lineEnd = this.point = Ga)
          },
          sphere: function () {
            fc.add(za)
          }
      ...
      function Dc(t, n) {
        ...
        if (Ac) {
          ...
          f ^ (a * Nc < c && c < a * t)
            ? (o = i[1] * La) > kc && (kc = o)
            : f ^ (a * Nc < (c = ((c + 360) % 360) - 180) && c < a * t)
            ? (o = -i[1] * La) < Tc && (Tc = o)
            : (n < Tc && (Tc = n), n > kc && (kc = n)),
            f
              ? t < Nc
                ? Yc(Mc, t) > Yc(Mc, Sc) && (Sc = t)
                : Yc(t, Sc) > Yc(Mc, Sc) && (Mc = t)
              : Sc >= Mc
              ? (t < Mc && (Mc = t), t > Sc && (Sc = t))
              : t > Nc
              ? Yc(Mc, t) > Yc(Mc, Sc) && (Sc = t)
      ...
      var $c,
        ...
        cf = function (t) {
          ...
          if (
            ...
            for (Rc.sort(Bc), n = 1, o = [(r = Rc[0])]; n < e; ++n)
              Hc(r, (i = Rc[n])[0]) || Hc(r, i[1])
                ? (Yc(r[0], i[1]) > Yc(r[0], r[1]) && (r[1] = i[1]),
                  Yc(i[0], r[1]) > Yc(r[0], r[1]) && (r[0] = i[0]))
                : o.push((r = i))
            for (
              ...
              (i = o[n]),
                (a = Yc(r[1], i[0])) > u && ((u = a), (Mc = i[0]), (Sc = r[1]))
          }
          return (
            (Rc = zc = null),
            Mc === 1 / 0 || Tc === 1 / 0
      ...
      function _f(t, n) {
        ...
        var e = qa(n)
        ;(of = e * qa(t)), (uf = e * Ba(t)), (af = Ba(n)), lf(of, uf, af)
      }
      function mf(t, n) {
        t *= Pa
        var e = qa((n *= Pa)),
      ...
      var xf = function (t) {
          ...
          return i < 1e-12 &&
            ...
            (e = Qc),
            (r = Jc),
            Xc < 1e-6 && ((n = Vc), (e = Wc), (r = Zc)),
            (i = n * n + e * e + r * r) < 1e-12)
            ? [NaN, NaN]
            : [Oa(e, n) * La, Wa(r / $a(i)) * La]
        },
        bf = function (t) {
          return function () {
            return t
      ...
      var Ef = function (t) {
        ...
        return (
          (t = Tf(t[0] * Pa, t[1] * Pa, t.length > 2 ? t[2] * Pa : 0)),
          (n.invert = function (n) {
            return (
              ((n = t.invert(n[0] * Pa, n[1] * Pa))[0] *= La), (n[1] *= La), n
            )
          }),
          n
        )
      ...
      function Cf(t, n, e, r, i, o) {
        if (e) {
          ...
          for (var f, s = i; r > 0 ? s > o : s < o; s -= c)
            (f = yc([u, -a * qa(s), -a * Ba(s)])), t.point(f[0], f[1])
        }
      }
      function Af(t, n) {
        ;((n = gc(n))[0] -= t), wc(n)
      ...
      var Rf = function () {
          ...
          return (
            (u.center = function (t) {
              return arguments.length
                ? ((e = 'function' == typeof t ? t : bf([+t[0], +t[1]])), u)
                : e
            }),
            (u.radius = function (t) {
              return arguments.length
                ? ((r = 'function' == typeof t ? t : bf(+t)), u)
                : r
            }),
            (u.precision = function (t) {
              return arguments.length
                ? ((i = 'function' == typeof t ? t : bf(+t)), u)
                : i
            }),
            u
          )
          ...
          (t.forEach(function (t) {
            if (!((n = t.length - 1) <= 0)) {
              ...
              if (Lf(r, u)) {
                ...
                a.push((e = new Pf(r, t, null, !0))),
                  c.push((e.o = new Pf(r, null, e, !1))),
                  a.push((e = new Pf(u, t, null, !1))),
                  c.push((e.o = new Pf(u, null, e, !0)))
            }
          }),
          a.length)
        ) {
          for (c.sort(n), Df(a), Df(c), o = 0, u = c.length; o < u; ++o)
            c[o].e = e = !e
          for (var f, s, l = a[0]; ; ) {
            ...
            var o,
              ...
              h = {
                ...
                polygonEnd: function () {
                  ...
                  var t = qf(o, r)
                  u.length
                    ? (l || (i.polygonStart(), (l = !0)), Uf(u, Ff, t, e, i))
                    : t &&
      ...
      function Ff(t, n) {
        return (
          ((t = t.x)[0] < 0 ? t[1] - Aa - 1e-6 : Aa - t[1]) -
          ((n = n.x)[0] < 0 ? n[1] - Aa - 1e-6 : Aa - n[1])
        )
      }
      var Yf = If(
        function () {
          ...
          return {
            ...
            point: function (o, u) {
              ...
              Ua(c - Ca) < 1e-6
                ...
                : i !== a &&
                  c >= Ca &&
                  (Ua(e - i) < 1e-6 && (e -= 1e-6 * i),
                  Ua(o - a) < 1e-6 && (o -= 1e-6 * a),
                  (r = (function (t, n, e, r) {
                    var i,
                      o,
                      u = Ba(t - e)
            ...
            return {
              ...
              point: function (l, h) {
                ...
                if (
                  (!n && (f = c = v) && t.lineStart(),
                  v !== c &&
                    (!(d = u(n, p)) || Lf(n, d) || Lf(p, d)) &&
                    ((p[0] += 1e-6), (p[1] += 1e-6), (v = o(p[0], p[1]))),
                  v !== c)
                )
                  (s = 0),
                    v
                      ? (t.lineStart(), (d = u(p, n)), t.point(d[0], d[1]))
                      : ((d = u(n, p)), t.point(d[0], d[1]), t.lineEnd()),
                    (n = d)
                else if (i && n && r ^ v) {
                  var g
                  y & e ||
      ...
      var ts = function (t) {
        ...
        ns = [null, null],
        es = { type: 'LineString', coordinates: ns },
        rs = function (t, n) {
      ...
      function vs() {
        ...
        function _() {
          return S(Ia(r / p) * p, e, p)
            .map(s)
            .concat(S(Ia(a / v) * v, u, v).map(l))
            .concat(
              S(Ia(n / h) * h, t, h)
                .filter(function (t) {
                  return Ua(t % p) > 1e-6
      ...
      var gs,
        ...
        Ss = {
          ...
          polygonEnd: function () {
            ;(Ss.lineStart = Ss.lineEnd = Ss.point = Ga),
              Ms.add(Ua(Ts)),
              Ts.reset()
          },
          result: function () {
          ...
          switch (this._point) {
            ...
            default:
              this._context.moveTo(t + this._radius, n),
                this._context.arc(t, n, this._radius, 0, za)
          }
        },
        result: Ga
      }
        ...
        point: function (t, n) {
          switch (this._point) {
            ...
            case 1:
              ...
              break
            default:
              null == this._circle && (this._circle = _l(this._radius)),
      ...
      var ml = function (t, n) {
          ...
          return (
            ...
            (o.context = function (t) {
              return arguments.length
                ? ((r = null == t ? ((n = null), new gl()) : new ul((n = t))),
      ...
      function zl(t) {
        ...
        return (
          ...
          function () {
            return (
              (n = t.apply(this, arguments)), (S.invert = n.invert && k), E()
            )
          }
        )
      }
      ...
      var rh = function () {
        ...
        return (o = {
          ...
          scale: function (t) {
            return arguments.length
              ? ((l = eh((u = +t) * f, u * s, a, c)), p())
              : u
          },
          translate: function (t) {
            return arguments.length
              ? ((l = eh(u * f, u * s, (a = +t[0]), (c = +t[1]))), p())
              : [a, c]
          },
          reflectX: function (t) {
            return arguments.length
              ? ((l = eh(u * (f = t ? -1 : 1), u * s, a, c)), p())
              : f < 0
          },
          reflectY: function (t) {
            return arguments.length
              ? ((l = eh(u * f, u * (s = t ? -1 : 1), a, c)), p())
              : s < 0
          },
        ...
        for (null == n && (n = _h); (e = f.pop()); )
          if (
            ...
            for (e.children = new Array(u), o = u - 1; o >= 0; --o)
              f.push((r = e.children[o] = new bh(i[o]))),
                (r.parent = e),
                (r.depth = e.depth + 1)
      ...
      var Mh = function (t) {
        for (
          ...
          (n = t[r]), e && kh(e, n) ? ++r : ((e = Eh((o = Th(o, n)))), (r = 0))
        return e
      }
      function Th(t, n) {
        var e, r
      ...
      function Nh(t, n) {
        for (var e = 0; e < n.length; ++e) if (!kh(t, n[e])) return !1
        return !0
      }
      function Eh(t) {
        switch (t.length) {
      ...
      function Ah(t, n, e) {
        ...
        return { x: r + w + M * C, y: i + T + S * C, r: C }
      }
      function Rh(t, n, e) {
        var r = t.x,
          i = t.y,
        ...
        if (f) {
          var s = 0.5 + ((u *= u) - (o *= o)) / (2 * f),
            l =
              Math.sqrt(Math.max(0, 2 * o * (u + f) - (u -= f) * u - o * o)) /
              (2 * f)
      ...
      function Uh(t) {
        ...
        t: for (a = 3; a < i; ++a) {
          ...
          for (
            r.previous = n, r.next = e, n.next = e.previous = e = r, o = Lh(n);
            (r = r.next) !== e;
      ...
      var Yh = function () {
        ...
        function i(i) {
          return (
            ...
            (i.y = e / 2),
            t
              ? i.eachBefore(Bh(t)).eachAfter(Hh(r, 0.5)).eachBefore($h(1))
              : i
                  .eachBefore(Bh(Fh))
                  .eachAfter(Hh(Ih, 1))
                  .eachAfter(Hh(r, i.r / Math.min(n, e)))
                  .eachBefore($h(Math.min(n, e) / (2 * i.r))),
            i
          )
        }
        return (
      ...
      function Hh(t, n) {
        return function (e) {
          if ((r = e.children)) {
            ...
            if (((o = Uh(r)), a)) for (i = 0; i < u; ++i) r[i].r -= a
            e.r = o + a
          }
        }
      }
      ...
      var ud = function () {
          ...
          function i(i) {
            var c = (function (t) {
              for (
                var n, e, r, i, o, u = new od(t, 0), a = [u];
                (n = a.pop());
                ...
                if ((r = n._.children))
                  for (
                    ...
                    a.push((e = n.children[i] = new od(r[i], i))),
                      (e.parent = n)
                ...
                for (
                  ...
                  (c = nd(c)),
                    ...
                    (i = a.z + l - o.z - f + t(a._, o._)) > 0 &&
                      (rd(id(a, n, r), n, i), (f += i), (s += i)),
                    (l += a.m),
                    (f += o.m),
                    (h += c.m),
                    (s += u.m)
                a && !ed(u) && ((u.t = a), (u.m += l - s)),
                  o && !nd(c) && ((c.t = o), (c.m += f - h), (r = n))
              }
              return r
            })(n, i, n.parent.A || r[0])
          }
      ...
      function fd(t, n, e, r, i, o) {
        for (
          ...
          g.push((u = { value: s, dice: c < f, children: _.slice(m, x) })),
            u.dice
              ? Vh(u, e, r, i, w ? (r += (f * s) / w) : o)
              : ad(u, e, r, w ? (e += (c * s) / w) : i, o),
            (w -= s),
            (m = x)
        }
        return g
            ...
            if ((u = t._squarify) && u.ratio === n)
              for (
                ...
                for (
                  ...
                  a.value += c[f].value
                a.dice
                  ? Vh(a, e, r, i, (r += ((o - r) * a.value) / d))
                  : ad(a, e, r, (e += ((i - e) * a.value) / d), o),
                  (d -= a.value)
              }
        ...
        return function (e, r) {
          t._tasks[n] &&
            ...
            null == t._error &&
              (null != e
                ? Nd(t, e)
                : ((t._data[n] = r), t._waiting ? Sd(t) : Ed(t))))
        }
      }
      function Nd(t, n) {
        var e,
      ...
      var Ad = function () {
        ...
        Od = function (t, n) {
          var e,
            ...
            i,
            o,
            u = dt('beforesend', 'progress', 'load', 'error'),
            a = fu(),
          ...
          if (
            ...
            'onload' in c
              ? (c.onload = c.onerror = c.ontimeout = h)
            ...
            (e = {
              ...
              send: function (n, i, h) {
                return (
                  ...
                  l > 0 && (c.timeout = l),
                  null == h && 'function' == typeof i && ((h = i), (i = null)),
                  null != h &&
                    1 === h.length &&
                    (h = (function (t) {
                      return function (n, e) {
                  ...
                  null != h &&
                    e.on('error', h).on('load', function (t) {
                      h(null, t)
                    }),
      ...
      function ap(t, n) {
        ...
        function f() {
          return (
            (e = Math.min(o.length, u.length) > 2 ? op : ip), (r = i = null), s
          )
        }
        function s(n) {
          return (
          ...
          (t.tickFormat = function (t, e) {
            return (function (t, n, e) {
              ...
              switch ((e = da(null == e ? ',f' : e)).type) {
                ...
                case 'r':
                  null != e.precision ||
                    isNaN((r = Ta(u, Math.max(Math.abs(i), Math.abs(o))))) ||
      ...
      function Tp() {
        ...
        return (
          (r.domain = function (i) {
            return arguments.length
              ? ((t = Zd.call(i)), (e = Math.min(t.length, n.length - 1)), r)
              : t.slice()
          }),
          (r.range = function (i) {
            return arguments.length
              ? ((n = Zd.call(i)), (e = Math.min(t.length, n.length - 1)), r)
              : n.slice()
          }),
        ...
        function M(t, n) {
          return function (e) {
            ...
            if (('p' in o && (o.H = (o.H % 12) + 12 * o.p), 'V' in o)) {
              ...
              'w' in o || (o.w = 1),
                'Z' in o
                  ? ((i = (r = Fv(Yv(o.y))).getUTCDay()),
                    (r = i > 4 || 0 === i ? bv.ceil(r) : bv(r)),
                    (r = gv.offset(r, 7 * (o.V - 1))),
                    (o.y = r.getUTCFullYear()),
                    (o.m = r.getUTCMonth()),
                    (o.d = r.getUTCDate() + ((o.w + 6) % 7)))
                  : ((i = (r = n(Yv(o.y))).getDay()),
                    (r = i > 4 || 0 === i ? $p.ceil(r) : $p(r)),
                    (r = Fp.offset(r, 7 * (o.V - 1))),
                    (o.y = r.getFullYear()),
                    (o.m = r.getMonth()),
              ...
              ('W' in o || 'U' in o) &&
                ...
                (i = 'Z' in o ? Fv(Yv(o.y)).getUTCDay() : n(Yv(o.y)).getDay()),
                (o.m = 0),
                (o.d =
                  'W' in o
                    ? ((o.w + 6) % 7) + 7 * o.W - ((i + 5) % 7)
                    : o.w + 7 * o.U - ((i + 6) % 7)))
            return 'Z' in o
              ? ((o.H += (o.Z / 100) | 0), (o.M += o.Z % 100), Fv(o))
              : n(o)
          }
        }
        function T(t, n, e, r) {
          for (var i, o, u = 0, a = n.length, c = e.length; u < a; ) {
            ...
            if (37 === (i = n.charCodeAt(u++))) {
              if (
                ((i = n.charAt(u++)),
                !(o = b[i in Zv ? n.charAt(u++) : i]) || (r = o(t, e, r)) < 0)
              )
                return -1
      ...
      function Ly(t, n) {
        var e = t.getDay()
        return (
          (t = e >= 4 || 0 === e ? Wp(t) : Wp.ceil(t)),
          Kv(Wp.count(cv(t), t) + (4 === cv(t).getDay()), n, 2)
        )
      }
      function Py(t) {
        return t.getDay()
      ...
      function Gy(t, n) {
        var e = t.getUTCDay()
        return (
          (t = e >= 4 || 0 === e ? Tv(t) : Tv.ceil(t)),
          Kv(Tv.count(qv(t), t) + (4 === qv(t).getUTCDay()), n, 2)
        )
      }
      function Qy(t) {
        return t.getUTCDay()
      ...
      var ug = Date.prototype.toISOString
        ...
        : Vv('%Y-%m-%dT%H:%M:%S.%LZ')
      var ag = +new Date('2000-01-01T00:00:00.000Z')
        ? function (t) {
            var n = new Date(t)
      ...
      function sg(t, n, e, r, i, o, u, c, f) {
        ...
        function M(n, e, r, i) {
          if ((null == n && (n = 10), 'number' == typeof n)) {
            ...
            u === b.length
              ? ((i = R(e / 31536e6, r / 31536e6, n)), (n = t))
              : u
              ? ((i = (u = b[o / b[u - 1][2] < b[u][2] / o ? u - 1 : u])[1]),
                (n = u[0]))
              : ((i = Math.max(R(e, r, n), 1)), (n = c))
          }
      ...
      var lg = function () {
          return sg(cv, ov, Hp, Fp, qp, Up, zp, Cp, $v).domain([
            new Date(2e3, 0, 1),
            new Date(2e3, 0, 2)
          ])
        },
        hg = function () {
          return sg(qv, Uv, xv, gv, pv, lv, zp, Cp, Vv).domain([
            Date.UTC(2e3, 0, 1),
            Date.UTC(2e3, 0, 2)
          ])
        },
        ...
        _g = Lr(je(300, 0.5, 0), je(-240, 0.5, 1)),
        mg = Lr(je(-100, 0.75, 0.35), je(80, 1.5, 0.8)),
        xg = Lr(je(260, 0.75, 0.35), je(80, 1.5, 0.8)),
        bg = je(),
        wg = function (t) {
      ...
      var Zg = function () {
        ...
        function c() {
          ...
          if (
            ...
            if (p > Ig - 1e-12)
              a.moveTo(l * zg(h), l * Ug(h)),
                a.arc(0, 0, l, h, d, !v),
                s > 1e-12 &&
                  (a.moveTo(s * zg(d), s * Ug(d)), a.arc(0, 0, s, d, h, v))
            else {
              var y,
                g,
                _ = h,
                ...
                S =
                  T > 1e-12 &&
                  (r ? +r.apply(this, arguments) : Dg(s * s + l * l)),
              ...
              M > 1e-12
                ? E > 1e-12
                    ...
                    E < k
                      ...
                      : (a.arc(
                        ...
                        a.arc(
                          ...
                          0,
                          l,
                          Rg(y.cy + y.y11, y.cx + y.x11),
                          Rg(g.cy + g.y11, g.cx + g.x11),
                          !v
                        ),
                        a.arc(
                          g.cx,
                  ...
                  : (a.moveTo(R, z), a.arc(0, 0, l, _, m, !v))
                : a.moveTo(R, z),
                s > 1e-12 && w > 1e-12
                  ? N > 1e-12
                    ? ((y = Wg(L, P, U, D, s, -N, v)),
        ...
        return (
          ...
          (c.innerRadius = function (n) {
            return arguments.length
              ? ((t = 'function' == typeof n ? n : Cg(+n)), c)
              : t
          }),
          (c.outerRadius = function (t) {
            return arguments.length
              ? ((n = 'function' == typeof t ? t : Cg(+t)), c)
              : n
          }),
          (c.cornerRadius = function (t) {
            return arguments.length
              ? ((e = 'function' == typeof t ? t : Cg(+t)), c)
              : e
          }),
          (c.padRadius = function (t) {
            return arguments.length
              ? ((r = null == t ? null : 'function' == typeof t ? t : Cg(+t)),
                c)
              : r
          }),
          (c.startAngle = function (t) {
            return arguments.length
              ? ((i = 'function' == typeof t ? t : Cg(+t)), c)
              : i
          }),
          (c.endAngle = function (t) {
            return arguments.length
              ? ((o = 'function' == typeof t ? t : Cg(+t)), c)
              : o
          }),
          (c.padAngle = function (t) {
            return arguments.length
              ? ((u = 'function' == typeof t ? t : Cg(+t)), c)
              : u
          }),
      ...
      var t_ = function () {
          ...
          return (
            (u.x = function (n) {
              return arguments.length
                ? ((t = 'function' == typeof n ? n : Cg(+n)), u)
                : t
            }),
            (u.y = function (t) {
              return arguments.length
                ? ((n = 'function' == typeof t ? t : Cg(+t)), u)
                : n
            }),
            (u.defined = function (t) {
              return arguments.length
                ? ((e = 'function' == typeof t ? t : Cg(!!t)), u)
                : e
            }),
            (u.curve = function (t) {
              return arguments.length
        ...
        n_ = function () {
          ...
          return (
            (c.x = function (e) {
              return arguments.length
                ? ((t = 'function' == typeof e ? e : Cg(+e)), (n = null), c)
                : t
            }),
            (c.x0 = function (n) {
              return arguments.length
            ...
            (c.x1 = function (t) {
              return arguments.length
                ? ((n = null == t ? null : 'function' == typeof t ? t : Cg(+t)),
                  c)
                : n
            }),
            (c.y = function (t) {
              return arguments.length
                ? ((e = 'function' == typeof t ? t : Cg(+t)), (r = null), c)
                : e
            }),
            (c.y0 = function (t) {
              return arguments.length
        ...
        i_ = function () {
          ...
          return (
            ...
            (u.startAngle = function (t) {
              return arguments.length
                ? ((r = 'function' == typeof t ? t : Cg(+t)), u)
                : r
            }),
            (u.endAngle = function (t) {
              return arguments.length
                ? ((i = 'function' == typeof t ? t : Cg(+t)), u)
                : i
            }),
            (u.padAngle = function (t) {
              return arguments.length
                ? ((o = 'function' == typeof t ? t : Cg(+t)), u)
                : o
            }),
            u
          )
      ...
      var w_ = {
        ...
        O_ = {
          draw: function (t, n) {
            ...
            t.moveTo(r, i),
              t.lineTo(o, u),
              t.lineTo(a, c),
              t.lineTo(-0.5 * r - P_ * i, P_ * r + -0.5 * i),
              t.lineTo(-0.5 * o - P_ * u, P_ * o + -0.5 * u),
              t.lineTo(-0.5 * a - P_ * c, P_ * a + -0.5 * c),
              t.lineTo(-0.5 * r + P_ * i, -0.5 * i - P_ * r),
              t.lineTo(-0.5 * o + P_ * u, -0.5 * u - P_ * o),
              t.lineTo(-0.5 * a + P_ * c, -0.5 * c - P_ * a),
              t.closePath()
          }
        },
        ...
        I_ = function () {
          ...
          return (
            (r.type = function (n) {
              return arguments.length
                ? ((t = 'function' == typeof n ? n : Cg(n)), r)
                : t
            }),
            (r.size = function (t) {
              return arguments.length
                ? ((n = 'function' == typeof t ? t : Cg(+t)), r)
                : n
            }),
          ...
          lineEnd: function () {
            ...
            if (e)
              if (
                ...
                for (var r = wm(t), i = wm(n), o = 0, u = 1; u < e; ++o, ++u)
      ...
      var Rm = function () {
          ...
          return (
            (i.keys = function (n) {
              return arguments.length
                ? ((t = 'function' == typeof n ? n : Cg(h_.call(n))), i)
                : t
            }),
            (i.value = function (t) {
              return arguments.length
                ? ((r = 'function' == typeof t ? t : Cg(+t)), i)
                : r
            }),
            (i.order = function (t) {
              return arguments.length
        ...
        insert: function (t, n) {
          ...
          for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
            e === (r = e.U).L
              ? (i = r.R) && i.C
                ? ((e.C = i.C = !1), (r.C = !0), (t = r))
                : (t === e.R && (Xm(this, e), (e = (t = e).U)),
                  (e.C = !1),
                  (r.C = !0),
                  Vm(this, r))
              : (i = r.L) && i.C
              ? ((e.C = i.C = !1), (r.C = !0), (t = r))
              : (t === e.L && (Vm(this, e), (e = (t = e).U)),
                (e.C = !1),
                (r.C = !0),
                Xm(this, r)),
              (e = t.U)
            ...
            if (t && t.C) t.C = !1
              ...
              do {
                ...
                if (t === i.L) {
                  if (
                    ((n = i.R).C &&
                      ((n.C = !1), (i.C = !0), Xm(this, i), (n = i.R)),
                    (n.L && n.L.C) || (n.R && n.R.C))
                  ) {
                    ;(n.R && n.R.C) ||
                      ((n.L.C = !1), (n.C = !0), Vm(this, n), (n = i.R)),
                      (n.C = i.C),
                      (i.C = n.R.C = !1),
                      Xm(this, i),
                      (t = this._)
                  ...
                  ((n = i.L).C &&
                    ((n.C = !1), (i.C = !0), Vm(this, i), (n = i.L)),
                  (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                  ;(n.L && n.L.C) ||
                    ((n.R.C = !1), (n.C = !0), Xm(this, n), (n = i.L)),
                    (n.C = i.C),
                    (i.C = n.L.C = !1),
                    Vm(this, i),
                    (t = this._)
      ...
      function Gm(t, n, e, r) {
        ...
        return (
          ...
          e && Jm(i, t, n, e),
          r && Jm(i, n, t, r),
          _x[t.index].halfedges.push(o),
          _x[n.index].halfedges.push(o),
          i
        )
      }
      function Qm(t, n, e) {
      ...
      function dx(t) {
        ...
        for (
          var c = o;
          c.circle &&
          Math.abs(e - c.circle.x) < bx &&
          Math.abs(r - c.circle.cy) < bx;

        )
          (o = c.P), a.unshift(c), hx(c), (c = o)
        a.unshift(c), cx(c)
        for (
          var f = u;
          f.circle &&
          Math.abs(e - f.circle.x) < bx &&
          Math.abs(r - f.circle.cy) < bx;

        )
          (u = f.N), a.push(f), hx(f), (f = u)
        a.push(f), cx(f)
        var s,
          l = a.length
        for (s = 1; s < l; ++s)
          (f = a[s]), (c = a[s - 1]), Jm(f.edge, c.site, f.site, i)
        ;(c = a[0]),
          ((f = a[l - 1]).edge = Gm(c.site, f.site, null, i)),
          ax(c),
          ax(f)
      }
      function px(t) {
        ...
        if ((gx.insert(n, c), n || e)) {
          if (n === e)
            return (
              ...
              (e = lx(n.site)),
              gx.insert(c, e),
              (c.edge = e.edge = Gm(n.site, c.site)),
              ax(n),
              void ax(e)
            )
          if (e) {
            ...
            Jm(e.edge, f, p, x),
              (c.edge = Gm(f, t, null, x)),
              (e.edge = Gm(t, p, null, x)),
              ax(n),
              ax(e)
      ...
      function Tx(t, n) {
        var e,
          ...
          o = t.sort(Mx).pop()
        for (
          xx = [], _x = new Array(t.length), gx = new Zm(), mx = new Zm();
          ;

        )
          if (
            ((i = ix), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x)))
          )
            (o[0] === e && o[1] === r) || (px(o), (e = o[0]), (r = o[1])),
              (o = t.pop())
          else {
            if (!i) break
            dx(i.arc)
        ...
        if (
          ...
          var u = +n[0][0],
            ...
            f = +n[1][1]
          !(function (t, n, e, r) {
            for (var i, o = xx.length; o--; )
              (tx((i = xx[o]), t, n, e, r) &&
                Km(i, t, n, e, r) &&
                (Math.abs(i[0][0] - i[1][0]) > bx ||
                  Math.abs(i[0][1] - i[1][1]) > bx)) ||
                delete xx[o]
          })(u, a, c, f),
            (function (t, n, e, r) {
              var i,
                ...
                if ((o = _x[i])) {
                  ...
                  for (a = 0, f = c.length; a < f; )
                    (p = (d = rx(o, xx[c[a]]))[0]),
                      ...
                      (l = (s = ex(o, xx[c[++a % f]]))[0]),
                      (h = s[1]),
                      (Math.abs(p - l) > bx || Math.abs(v - h) > bx) &&
                        (c.splice(
                          a,
                          0,
                          xx.push(
                            Qm(
                              u,
                              d,
                              Math.abs(p - t) < bx && r - v > bx
                                ? [t, Math.abs(l - t) < bx ? h : r]
                                : Math.abs(v - r) < bx && e - p > bx
                                ? [Math.abs(h - r) < bx ? l : e, r]
                                : Math.abs(p - e) < bx && v - n > bx
                                ? [e, Math.abs(l - e) < bx ? h : n]
                                : Math.abs(v - n) < bx && p - t > bx
                                ? [Math.abs(h - n) < bx ? l : t, n]
                                : null
                            )
                          ) - 1
                        ),
              ...
              for (i = 0; i < y; ++i)
                (o = _x[i]) && (o.halfedges.length || delete _x[i])
            })(u, a, c, f)
        }
      ...
      var Sx = function () {
          ...
          function r(r) {
            return new Tx(
              r.map(function (e, i) {
                var o = [
                  Math.round(t(e, i, r) / bx) * bx,
                  Math.round(n(e, i, r) / bx) * bx
                ]
          ...
          return (
            ...
            (r.x = function (n) {
              return arguments.length
                ? ((t = 'function' == typeof n ? n : Fm(+n)), r)
                : t
            }),
            (r.y = function (t) {
              return arguments.length
                ? ((n = 'function' == typeof t ? t : Fm(+t)), r)
                : n
            }),
            (r.extent = function (t) {
              return arguments.length
      ...
      Ex.prototype = {
        ...
        translate: function (t, n) {
          return (0 === t) & (0 === n)
            ? this
            : new Ex(this.k, this.x + this.k * t, this.y + this.k * n)
        },
        apply: function (t) {
      ...
      var Ix = function () {
        ...
        function b() {
          if (e.apply(this, arguments)) {
            ...
            zx(),
              ...
              t.zoom(
                'mouse',
                i(y(v(n, r), t.mouse[0], t.mouse[1]), t.extent, c)
              )
          }
          function f() {
            ;(t.wheel = null), t.end()
        ...
        function w() {
          ...
          function f() {
            ...
            t.zoom(
              'mouse',
              i(
                y(t.that.__zoom, (t.mouse[0] = Dn(t.that)), t.mouse[1]),
                t.extent,
                c
              )
            )
        ...
        function M() {
          if (e.apply(this, arguments)) {
            var t = this.__zoom,
              n = Dn(this),
              o = t.invert(n),
              u = t.k * (vn.shiftKey ? 0.5 : 2),
              a = i(y(v(t, u), n, o), r.apply(this, arguments), c)
            zx(),
              f > 0
                ? Cn(this).transition().duration(f).call(_, a, n)
                : Cn(this).call(p.transform, a)
          }
        }
        function T() {
          if (e.apply(this, arguments)) {
            ...
            if (t && ((t = clearTimeout(t)), !u.touch1))
              return (
                u.end(),
                void (
                  (o = Cn(this).on('dblclick.zoom')) && o.apply(this, arguments)
                )
              )
            n &&
        ...
        function S() {
          var n,
            ...
            a = vn.changedTouches,
            f = a.length
          for (zx(), t && (t = clearTimeout(t)), n = 0; n < f; ++n)
            (e = a[n]),
              (r = qn(this, a, e.identifier)),
        ...
        return (
          (p.transform = function (t, n) {
            var e = t.selection ? t.selection() : t
            e.property('__zoom', Ux),
              t !== e
                ? _(t, n)
          ...
          (x.prototype = {
            ...
            emit: function (t) {
              bn(new Nx(p, t, this.that.__zoom), h.apply, h, [
                t,
                this.that,
                this.args
              ])
          ...
          (p.wheelDelta = function (t) {
            return arguments.length
              ? ((o = 'function' == typeof t ? t : kx(+t)), p)
              : o
          }),
          (p.filter = function (t) {
            return arguments.length
              ? ((e = 'function' == typeof t ? t : kx(!!t)), p)
              : e
          }),
          (p.touchable = function (t) {
            return arguments.length
              ? ((u = 'function' == typeof t ? t : kx(!!t)), p)
              : u
          }),
          (p.extent = function (t) {
            return arguments.length
      ...
      const jx = /translate\(([^)]*)\)/i,
        Fx = /scale\((\S*)\)/i,
        Yx = 'curve',
        Bx = 'straight',
        Hx = { VERTICAL: 'vertical', HORIZONTAL: 'horizontal' }
      function $x() {
        const t = []
        for (let n = 0; n < 36; n++)
      ...
      var Vx = {
        ...
        props: {
          ...
          linkStyle: { type: String, default: Yx },
          direction: { type: String, default: Hx.VERTICAL },
        ...
        methods: {
          ...
          setScale(t) {
            ...
            const n = this.$refs.domContainer.style.transform
            let e
            ;(e = n.match(Fx)
              ? n.replace(Fx, `scale(${t})`)
              : n + ` scale(${t})`),
              (this.$refs.svg.style.transform = e),
              (this.$refs.domContainer.style.transform = e)
          },
          isVertial() {
          ...
          generateLinkPath(t) {
            ...
            if (this.linkStyle === Yx) {
              ...
              return (
                e
                  ...
                  .source(function (t) {
                    const e = { x: t.source.x, y: t.source.y }
                    return n.direction === n.DIRECTION.VERTICAL ? e : Xx(e)
                  })
                  .target(function (t) {
                    const e = { x: t.target.x, y: t.target.y }
                    return n.direction === n.DIRECTION.VERTICAL ? e : Xx(e)
                  }),
                e(t)
              )
            ...
            if (this.linkStyle === Bx) {
              const n = tu()
              let e = { x: t.source.x, y: t.source.y },
                r = { x: t.target.x, y: t.target.y }
              this.isVertial() || ((e = Xx(e)), (r = Xx(r)))
              const i = r.x - e.x,
                o = r.y - e.y,
                u = this.isVertial()
                  ? { x: e.x, y: e.y + o / 2 }
          ...
          draw() {
            ...
            const e = this,
              r = this.svg
                .selectAll('.link')
                .data(n, (t) => `${t.source.data._key}-${t.target.data._key}`)
            r
              .enter()
              .append('path')
              .style('opacity', 0)
          ...
          enableDrag() {
            ...
            ;(n.onmousedown = (n) => {
              ...
              (n.onmousemove = (n) => {
                ...
                let f = `translate(${n.clientX - e + a}px, ${
                  n.clientY - r + c
                }px)`
                u && (f = u.replace(jx, f)),
                  (t.style.transform = f),
                  (this.$refs.domContainer.style.transform = f)
              }),
              (n.onmouseup = (t) => {
                ;(e = 0), (r = 0), (i = !1)
              })
          ...
          formatDimension: (t) =>
            'number' == typeof t
              ...
              ? t
              : t + 'px',
          parseDimensionNumber: (t) =>
            'number' == typeof t ? t : parseInt(t.replace('px', ''))
        },
        watch: {
          dataset() {
            this.draw()
